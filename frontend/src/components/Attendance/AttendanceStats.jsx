    ...
    <div className='grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5 mb-8'>
      {stats.map((s)=>(
        <div key={s.label} className='card card-hover p-5 sm:p-6 flex items-center gap-4 relative overflow-hidden group' >
          ...
          <div className='p-3 bg-slate-100 rounded-lg group-hover:bg-indigo-50 transform-colors duration-200'>
            <s.icon className='w-5 h-5 text-slate-600 group-hover:text-indigo-600 transform-colors duration-200' />
          </div>
          <div>
