  ...
  return (
    <form onSubmit={handleSubmit} className='space-y-6 max-w-3xl animate-fade-in'>
        ...
        <div className="card p-5 sm:p-6">
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-5 text:sm text-slate-700'>
                ...
                <div className='sm:col-span-2'>
                    ...
                    <input name='phone'  defaultValue={initialData?.bio} rows={3} className='resize-none' placeholder='Brief Description... ' />
                </div>
        ...
        <div className='card p-5 sm:p-6'>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700'>
                ...
                <div>
                    ...
                    <input type='number' name='allwonaces' required min="0" step="0.01" defaultValue={initialData?.allwonaces || 0} />
                </div> 
                <div>
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 gap-5 text:sm text-slate-700'>
               ...
               {isEditMode && (
                <div className=''>
                    ...
                    <input placeholder='Leave blank to keep current' type='password' name='password' required />
                </div>
               )}
                <div className=''>
        ...
        <div className='flex flex-col-reverse sm:flex-row justify-end gap-3 pt-2'>
               <button onClick={()=>(onCancel ? onCancel() : naviagate(-1))} type='button' className='btn-secondary'>
                Cancel
               </button>
               <button type='submit' disabled={loading} className='btn-primary flex items-center justify-center'>
                {loading && <Loader2Icon className='w-4 h-4'/>}
