    ...
    <div className="animate-fade-in">
      ...
      {loading ? (
        <div className="flex justify-center p-12">
          <div className="animate-spin h8 w8 border-2 border-indigo-600 border-t-transparent rounded-full" />
        </div>
      ) : (
        ...
        <div className="fixed bg-black/40 backdrop-blur-sm inset-0 z-50 flex items-start justify-center p-4 overflow-y-auto" onClick={()=>setShowCreateModal(false)} >
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-3xl my-8 animate-fade-in" onClick={(e)=> e.stopPropagation()}>
            <div className="flex items-center justify-between p-6 pb-0">
              <div >
                <h2 className="text-lg font-semibold text-sky-900">Add new Employee</h2>
      ...
      {editEmployee && (
        <div onClick={()=> setEditEmployee(null)} className="fixed inset-0 z-50 flex items-start justify-center p-4 overflow-y-auto bg-black/40 backdrop-blur-sm">
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-3xl my-8 animate-fade-in" onClick={(e)=>e.stopPropagation()}>
              <div className="flex items-center justify-between p-6 pb-0">
                <div >
                <h2 className="text-lg font-semibold text-sky-900">Edit employess</h2>
